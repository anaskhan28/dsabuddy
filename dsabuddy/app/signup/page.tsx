  ...
  return (
    <div className=' flex flex-col md:flex-row justify-center md:justify-normal items-center w-full'>
        <div className='hidden md:flex flex-col  w-1/2 bg-[#F7FAFC] h-screen p-6 '>
            <Link href="/"><Image src='/logo-black.png' className='' width={200} height={250} alt='DSABuddy'/>
</Link>
<div className='flex justify-center items-center h-full w-full'>
            <Image src='/rocket.svg' className='' width={600} height={600} alt='DSABuddy'/>
        ...
        <div className='flex flex-col gap-8 md:gap-16 p-12 mt-[7rem] justify-center md:justify-between items-center w-1/2'>
            <div className='flex flex-col gap-1 px-8 md:px-24  md:mt-[-12rem]'>
                <span className='md:text-lg text-md font-light space-x-2 text-white'>Welcome to DSA<span className='text-blue-500 font-bold'>Buddy</span></span>
                <h1 className='text-lg md:text-2xl font-bold text-white'>Start your DSA journey with us</h1>
            </div>
          ...
          //  onClick={loginWithGoogle}
            ...
            className='flex justify-center items-center gap-3
             py-2 px-14 bg-[#51505c] hover:hover:bg-[#393D44] text-white rounded-md text-md font-light text-center'>
                ...
                <span className='text-center font-light text-md text-white '>Already have an account? <Link href="/login" className='text-blue-600 hover:underline hover:underline-offset-3
'>Login Now</Link></span>
            </div>
