...
const Track: React.FC = () => {
  ...
  return (
    <div className="flex flex-col md:flex-row min-h-screen bg-black-800 text-white">
      <SideNavbar />
                ...
                <tbody className="bg-gray-800 divide-y divide-gray-700">
                  {problems.slice(0, 15).map((problem, index) => (
                    <tr key={index} className="hover:bg-gray-700">
                      <td className="px-4 md:px-6 py-4 whitespace-nowrap text-sm text-gray-200 md:text-base">{problem.title || problem.name}</td>
